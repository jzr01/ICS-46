...
bool verifysolution(node* answer, int count, string s1,string s2, string s3)
...
bool find_answer(int count, node* answer, int n,string s1, string s2, string s3,unordered_map<char,unsigned> & mapping)
